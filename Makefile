...
mx53_bej_android_config		\
mx53_bej_config		:unconfig
	$(MKCONFIG) $(@:_config=) arm arm_cortexa8 mx53_bej freescale mx53

mx53_bej2_mfg_config             \
mx53_bej2_android_config		\
mx53_bej2_android_sdwrite_config		\
mx53_bej2_android_sdtest_config		\
mx53_bej2_config		:unconfig
	$(MKCONFIG) $(@:_config=) arm arm_cortexa8 mx53_bej2 freescale mx53
